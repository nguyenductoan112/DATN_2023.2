    ...
    <div class="pos_page">
        <div class="container">
            ...
            <div class="pos_page_inner">
                    ...
                    <div class="header_middel">
                        <div class="row align-items-center">
                            <div class="col-lg-3 col-md-3">
                                <div class="logo">
                                    <a href="#"><img src="../assets\img\logo\logo1.jpg" alt="img"
                ...
                <h1 style="font-size: 40px; padding: 20px 50px">Cập nhật thông tin</h1>
                <div class="row" style="padding: 10px 50px">
                    <div class="col-5">
                        <form action="{{ route('myupdate', $user->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <button type="submit" class="btn btn-primary"
                                style=" border-radius: 10px;font-size: 16px; padding: 5px 30px; margin-top: 10px;">Sửa</button>
                        </form>
                    </div>
                </div>
